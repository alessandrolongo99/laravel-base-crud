    ...
    <div class="container">
        ...
        <form action="{{ route('comics.update', $comic->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control" name="price" id="price" value="{{ old('price', $comic->price) }}">
            </div>
            <div class="mb-3">
                <label for="series" class="form-label">Serie</label>
                <input type="text" class="form-control" name="series" id="series" value="{{ series('series', $comic->series) }}">
            </div>
            <div class="mb-3">
